...
L.INCLUDE_WARBOUND = "Incluir itens vinculados ao Bando"
L.INCLUDE_WARBOUND_TIP = "Itens vinculados ao Bando ficam ocultos por padrão, pois aprimorá-los os vincula a um único personagem."
L.SHOW_FULLY_UPGRADED = "Mostrar equipamento totalmente aprimorado"
L.SHOW_FULLY_UPGRADED_TIP = "Quando desativado, oculta o equipamento que você está usando e não pode aprimorar: tanto os itens totalmente aprimorados quanto os sem trilha de aprimoramento."
L.EQUIPPED_NONE_UPGRADEABLE = "Nada do seu equipamento atual pode ser aprimorado no momento."
L.SHOW_CRESTS = "Mostrar meus brasões"

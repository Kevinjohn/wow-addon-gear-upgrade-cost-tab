...
L.SHOW_FULLY_UPGRADED = "Mostra l'equipaggiamento completamente potenziato"
L.SHOW_FULLY_UPGRADED_TIP = "Quando è disattivato, nasconde l'equipaggiamento indossato che non puoi potenziare: sia gli oggetti completamente potenziati sia quelli senza un percorso di potenziamento."
L.EQUIPPED_NONE_UPGRADEABLE = "Al momento nessun oggetto equipaggiato può essere potenziato."
L.SHOW_CRESTS = "Mostra i miei emblemi"

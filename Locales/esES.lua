...
L.SHOW_FULLY_UPGRADED = "Mostrar equipo completamente mejorado"
L.SHOW_FULLY_UPGRADED_TIP = "Cuando está desactivado, oculta el equipo que llevas puesto y no puedes mejorar: tanto los objetos completamente mejorados como los que no tienen vía de mejora."
L.EQUIPPED_NONE_UPGRADEABLE = "Ninguna de tus piezas equipadas puede mejorarse ahora mismo."
L.SHOW_CRESTS = "Mostrar mis blasones"

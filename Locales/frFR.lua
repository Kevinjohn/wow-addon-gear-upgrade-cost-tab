...
L.INCLUDE_WARBOUND = "Inclure les objets liés au bataillon"
L.INCLUDE_WARBOUND_TIP = "Les objets liés au bataillon sont masqués par défaut, car les améliorer les lie définitivement à ce personnage."
L.SHOW_FULLY_UPGRADED = "Afficher l’équipement entièrement amélioré"
L.SHOW_FULLY_UPGRADED_TIP = "Une fois désactivé, masque l’équipement porté que vous ne pouvez pas améliorer : aussi bien les objets entièrement améliorés que ceux sans palier d’amélioration."
L.EQUIPPED_NONE_UPGRADEABLE = "Rien dans votre équipement porté ne peut être amélioré pour le moment."
L.SHOW_CRESTS = "Afficher mes écus"

...
L.INCLUDE_WARBOUND = "Включать предметы, привязанные к отряду"
L.INCLUDE_WARBOUND_TIP = "Предметы, привязанные к отряду, по умолчанию скрыты: после улучшения они становятся персональными."
L.SHOW_FULLY_UPGRADED = "Показывать полностью улучшенное снаряжение"
L.SHOW_FULLY_UPGRADED_TIP = "Если выключено, скрывает надетые предметы, которые нельзя улучшить: как полностью улучшенные, так и без пути улучшения."
L.EQUIPPED_NONE_UPGRADEABLE = "Сейчас среди надетого снаряжения нет предметов, которые можно улучшить."
L.SHOW_CRESTS = "Показывать мои гербы"
